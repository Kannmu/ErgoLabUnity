...
public class SettingSceneController : MonoBehaviour
{
    ...
    public TMP_InputField TMP_SubjectNum, TMP_RoundsPerSubject, TMP_IndependentVarNum, TMP_DependentVarNum;
    ...
    {
        //Debug.Log(TMP_ExpType.options[TMP_ExpType.value].text);
        //JsonFile.WriteSetting(null);
        try
        {
